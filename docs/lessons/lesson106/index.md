# lesson106: 次世代ツールチェイン（Biome / Oxc / Turbopack）
...
Vite 8（lesson104）が **Rolldown を採用**、Rolldown は **Oxc を内蔵** しています。つまり Oxc は **Vite / Rolldown / 多くの新ツール** の土台になりつつある。

Oxc は **VoidZero**（Evan You が立ち上げた会社）が支援しており、Vite / Rolldown と **同じ会社の同じ方向性** で開発が進んでいます。

### Rolldown

Vite 8 から採用された **Rust 製バンドラ**（lesson104 で扱い済み）。
