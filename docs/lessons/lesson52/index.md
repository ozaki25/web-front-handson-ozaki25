...
「変わった箇所だけ DOM に反映する」を支える仕組みが **仮想 DOM**（virtual DOM） です。React の代名詞としてよく語られる概念なので、ここで一度きちんと押さえます。
...
参考: [仮想 DOM について（スライド）](https://speakerdeck.com/ozaki25/20190122-vdom?slide=22)
