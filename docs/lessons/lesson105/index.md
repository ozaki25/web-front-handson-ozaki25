...
ボタンや入力欄のような個々のコンポーネントごとに **見た目のカタログ**を作るためのツール、と捉えるのが分かりやすいです。Shopify や Microsoft のデザインシステムも Storybook で公開されています。
...
- 下部パネルの **Accessibility** タブに **No accessibility violations found** と表示される
