...
function onMessage(e: MessageEvent) {
  if (!e.data || e.data.type !== "wfh-repl-log") return;
...
(function(){
  ...
  function send(level, args){parent.postMessage({type:'wfh-repl-log',level,text:args.map(fmt).join(' ')}, TARGET)}
