...
export const chapter3: Quiz[] = [
  {
    ...
    answer: 1,
    explanation: "TypeScript は JavaScript に型の仕組みを追加した言語です。静的型付けにより、実行前（コンパイル時）に型の食い違いを検出できます。最終的に JavaScript にコンパイルして実行します。",
  },
  {
    id: "q089",
    lesson: "lesson41",
    ...
    answer: 2,
    explanation: "型注釈は変数名の後ろに ': 型名' を書きます。const age: number = 20 のように書くと、age に文字列などを代入しようとすると型エラーになります。",
  },
  {
    id: "q090",
    lesson: "lesson41",
    ...
    answer: 0,
    explanation: "TypeScript は tsc コンパイラで JavaScript に変換されます。型注釈はコンパイル後の JS には残りません。型チェックはコンパイル時（実行前）にのみ行われ、実行時のオーバーヘッドはゼロです。",
  },
  {
    id: "q091",
    lesson: "lesson42",
    ...
    answer: 2,
    explanation: "void は「値を返さない」関数の戻り値型です。console.log を呼ぶだけで何も return しない関数に使います。never は「絶対に到達しない」ことを表す型で、意味が異なります。",
  },
  {
    id: "q092",
    lesson: "lesson42",
    ...
    answer: 0,
    explanation: "引数名の後ろの : number が引数の型、閉じ括弧の後ろの : number が戻り値の型を指定します。文字列を渡したり、文字列を return しようとすると型エラーになります。",
  },
  {
    id: "q093",
    lesson: "lesson43",
    ...
    answer: 0,
    explanation: "type User = { name: string; age: number } のように名前を付けると、変数や関数引数に : User と書くだけで同じ型を使い回せます。型を変更する場合も type 定義を 1 箇所直すだけで済みます。",
  },
  {
    id: "q094",
    lesson: "lesson43",
    ...
    answer: 2,
    explanation: "TypeScript のオブジェクト型リテラル（{ name: string; age: number }）ではプロパティの区切りにセミコロン（;）を使うのが慣例です。なお値のオブジェクトリテラル（{ name: 'Alice', age: 20 }）の区切りはカンマ（,）です。",
  },
  {
    id: "q095",
    lesson: "lesson44",
    ...
    answer: 3,
    explanation: "interface は extends による継承が得意で、クラスの implements にも使えます。type はユニオン型（A | B）やインターセクション型（A & B）など幅広い型表現が書けます。本コースでは type を基本に使います。",
  },
  {
    id: "q096",
    lesson: "lesson45",
    ...
    answer: 0,
    explanation: "パイプ（|）で複数の型をつなぐとユニオン型になります。string | number は「文字列または数値」を表します。どちらの型でも代入できますが、共通して使えるメソッド以外は使えません。",
  },
  {
    id: "q097",
    lesson: "lesson45",
    ...
    answer: 0,
    explanation: "リテラル型は特定の値のみを許す型です。'open' | 'done' は文字列リテラル型のユニオンで、他の文字列（'pending' など）を代入しようとすると型エラーになります。",
  },
  {
    id: "q098",
    lesson: "lesson45",
    ...
    answer: 0,
    explanation: "?: を付けると省略可能なプロパティになります。memo?: string は「存在する場合は string、存在しない場合は undefined」を意味します。なお memo: string | undefined も似ていますが、?: は「キー自体が存在しなくてもよい」のに対し後者は「キーは存在するが値が undefined でもよい」という違いがあります。",
  },
  {
    id: "q099",
    lesson: "lesson46",
    ...
    answer: 0,
    explanation: "any はどんな値でも受け入れ、何でも呼び出せます。しかし型チェックが無効になるため、実行時エラーを防ぐという TypeScript の恩恵がなくなります。代わりに unknown を使い、型を絞り込んでから使うのが安全です。",
  },
  {
    id: "q100",
    lesson: "lesson46",
    ...
    answer: 2,
    explanation: "unknown はどんな値でも受け入れますが、そのままでは何もできません。プロパティアクセスやメソッド呼び出しはすべてエラーになります。typeof や instanceof で型を絞り込んでから使います。",
  },
  {
    id: "q101",
    lesson: "lesson47",
    ...
    answer: 2,
    explanation: "型ガードは typeof / in / instanceof などを使った条件分岐によって、その分岐内での変数の型を絞り込む仕組みです。TypeScript がコードを解析して絞り込まれた型として扱います。",
  },
  {
    id: "q102",
    lesson: "lesson47",
    ...
    answer: 0,
    explanation: "ユーザー定義型ガードは戻り値型に「引数名 is 型名」を書きます。function isTodo(x: unknown): x is Todo のように書くと、この関数が true を返したブロック内では x が Todo 型として扱われます。",
  },
  {
    id: "q103",
    lesson: "lesson48",
    ...
    answer: 2,
    explanation: "判別共用体は kind: 'circle' | kind: 'square' のような「種類を表す共通プロパティ（判別子）」を全ケースに持ちます。switch(shape.kind) で分岐すると TypeScript が自動的に型を絞り込んでくれます。",
  },
  {
    id: "q104",
    lesson: "lesson48",
    ...
    answer: 1,
    explanation: "全ケースを switch で処理した後に default で変数を never 型の変数に代入すると、新しいケースが union に追加されたとき「X は never に代入できない」という型エラーが出ます。これが判別共用体の網羅性チェックです。",
  },
  {
    id: "q105",
    lesson: "lesson49",
    ...
    answer: 0,
    explanation: "ジェネリクスは「型を引数として受け取る」仕組みです。function first<T>(arr: T[]): T | undefined のように書くと、数値配列でも文字列配列でも同じ関数が使えます。呼び出し時に型推論で T が決まります。",
  },
  {
    id: "q106",
    lesson: "lesson49",
    ...
    answer: 1,
    explanation: "TypeScript は引数 [1, 2, 3] から要素の型が number だと推論し、T = number と決定します。明示的に first<number>([1, 2, 3]) と書かなくても型推論が働きます。",
  },
  {
    id: "q107",
    lesson: "lesson50",
    ...
    answer: 1,
    explanation: "Partial<User> は User の全プロパティを optional（?:）にします。フォームの「編集中の下書き」や「更新時に変更したフィールドだけ送る」場面で便利です。",
  },
  {
    id: "q108",
    lesson: "lesson50",
    ...
    answer: 3,
    explanation: "Pick<T, K> は型 T から K に指定したキーのプロパティだけを取り出した型を作ります。一覧表示に必要な最小限のプロパティだけの型を派生させるときに使います。",
  },
  {
    id: "q109",
    lesson: "lesson51",
    ...
    answer: 2,
    explanation: "\"strict\": true は strictNullChecks（null/undefined の扱いを厳格化）や noImplicitAny（暗黙の any を禁止）などを一括で有効にします。新規プロジェクトでは常に true にするのが推奨です。",
  },
  {
    id: "q110",
    lesson: "lesson51",
    ...
    answer: 3,
    explanation: "moduleResolution: 'bundler' は Vite / esbuild などのバンドラーが拡張子を自動解決する動作に合わせた設定です。フロントエンドプロジェクトで推奨されます。Node.js のネイティブ実行には 'node16' や 'nodenext' が適切です。",
  },
  {
    id: "q111",
    lesson: "lesson51",
    ...
    answer: 1,
    explanation: "verbatimModuleSyntax は型だけを import するときに import type を使うよう強制します。これにより、実行時には不要な型 import が JS 出力に残らないことが保証されます。Node.js ネイティブ TypeScript 実行環境で推奨されます。",
  },
];
